...
{
    SystemExceptions test("System not found");
...
{
    ServerExceptions test("Server not found");
...
{
    EntityExceptions test("Entity not found");
...
{
    ComponentExceptions test("Component not found");
...
{
    ECSExceptions test("ECS not found");
