...
** Untitled (Workspace)
** File description:
** BackgroundWithoutTitleEntity.hpp
*/

#ifndef BACKGROUNDWITHOUTTITLEENTITY_HPP__
#define BACKGROUNDWITHOUTTITLEENTITY_HPP__
...
class BackgroundWithoutTitleEntity : public IEntityConstructor
{
public:
    BackgroundWithoutTitleEntity() = default;
    ~BackgroundWithoutTitleEntity() = default;
...
#endif //BACKGROUNDWITHOUTTITLEENTITY_HPP__