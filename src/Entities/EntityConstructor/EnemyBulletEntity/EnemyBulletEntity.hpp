...
#ifndef ENEMYBULLETENTITY_HPP__
#define ENEMYBULLETENTITY_HPP__
...
class EnemyBulletEntity : public IEntityConstructor
{
public:
    EnemyBulletEntity() = default;
    ~EnemyBulletEntity() = default;
