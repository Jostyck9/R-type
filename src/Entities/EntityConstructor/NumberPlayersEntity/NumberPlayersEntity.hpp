...
** Untitled (Workspace)
** File description:
** NumberPlayersEntity.hpp
*/

#ifndef NUMBERPLAYERSENTITY_HPP__
#define NUMBERPLAYERSENTITY_HPP__
...
class NumberPlayersEntity : public IEntityConstructor
{
public:
    NumberPlayersEntity() = default;
    ~NumberPlayersEntity() = default;
...
#endif //NUMBERPLAYERSENTITY_HPP__