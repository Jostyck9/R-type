...
** Untitled (Workspace)
** File description:
** EnemyType02Entity.hpp
*/

#ifndef ENEMYTYPE02ENTITY_HPP__
#define ENEMYTYPE02ENTITY_HPP__
...
class EnemyType02Entity : public IEntityConstructor
{
public:
    EnemyType02Entity() = default;
    ~EnemyType02Entity() = default;
